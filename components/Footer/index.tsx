          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                Tech Sath is a pioneering startup company dedicated to providing comprehensive training in various cutting-edge technologies, including web development, Python programming, and other specialized tech fields.

                </p>
                <div className="flex items-center">
                  <a
                    href="https://www.facebook.com/people/Techsathin/100093370698962/?mibextid=ZbWKwL"
                  ...
                  <a
                    href="https://www.linkedin.com/company/techsath/"
                    aria-label="social-link"
                    className="mr-6 text-[#CED3F6] hover:text-primary"
                  >
                    <svg
...
Telangana,India{" "}
                  ...
                  <li>
                    <a
                      href="/"
                      className="mb-4 inline-block text-base font-medium text-body-color "
                    >
                      {" "}
...
{" "}
                  ...
                  <li>
                    <a
                      href="mailto:techsathofficial@gmail.com"
                      className="mb-4 inline-block text-base font-medium text-body-color hover:text-primary"
                    >
                      {" "}
                      techsathofficial@gmail.com{" "}
                    </a>
                  </li>
                </ul>
              </div>
